...
changelog identify 0.8.6 as unreleased; AppStream identifies a dated development
...
```bash
python scripts/tag_release.py v0.8.6 --repo OWNER/REPOSITORY
git push RELEASE_REMOTE v0.8.6
```
...
```bash
python scripts/release_assets.py stage v0.8.6 --repo OWNER/REPOSITORY --files dist/PACKAGE
python scripts/release_assets.py publish v0.8.6 --repo OWNER/REPOSITORY --acceptance dist/release-acceptance.json
```
